...
echo ========================================
echo  Mat3amPOS v39 build (same pattern as v38)
echo ========================================
...
echo [3/4] PyInstaller (Mat3amPOS_39.spec) --clean...
python -m PyInstaller "%~dp0Mat3amPOS_39.spec" --clean --noconfirm
if errorlevel 1 exit /b 1

echo [4/4] Done ^> dist\mat3amPos_39.exe
echo ========================================
pause
